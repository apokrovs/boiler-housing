...
export type Body_lease_agreements_update_lease_agreement = {
  description?: string
}

export type Body_lease_agreements_upload_lease_agreement = {
  file: Blob | File
  description?: string
}
...
export type LeaseAgreementsUploadLeaseAgreementData = {
  currentUser?: unknown
  formData: Body_lease_agreements_upload_lease_agreement
  listingId: string
}

export type LeaseAgreementsUploadLeaseAgreementResponse = LeaseAgreementPublic
...
export type LeaseAgreementsDeleteLeaseAgreementResponse = unknown
...
export type LeaseAgreementsGetLeaseAgreementsResponse =
  Array<LeaseAgreementPublic>
