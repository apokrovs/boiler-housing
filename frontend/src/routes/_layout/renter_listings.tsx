...
function RenterListings() {
   ...
   const parseDateArray = (dateStr: string): number[] => {
       const clean = dateStr.replace(/"/g, '');
   ...
   function handeliCalExport(leaseStart: string, leaseEnd: string) {
       const eventTitle = "Lease Period";
       const startTime = parseDateArray(leaseStart)
       const endTime = parseDateArray(leaseEnd)
       const eventData ={
           title: eventTitle,
                                               ...
                                               <MenuList zIndex="popover">
                                                   <>
                                                       <MenuItem
                                                           ...
                                                           Google</MenuItem>
                                                       <MenuItem
                                                           onClick={() => handeliCalExport(listing.lease_start_date ?? ""
                                                               , listing.lease_end_date ?? "")}>Export to
                                                           iCal</MenuItem>
